import type { Config, McpServerWithState } from "@/types/config";
 ...
 */
export function cleanConfigForSave(config: Config, mcpServersConfig: Record<string, McpServerWithState>): any {
  const cleaned: any = {
    ...config,
  };
